...
function Myaccount() {
  ...
  return (
    ...
    <section className="text-gray-600 bg-[#f7f7f7] body-font relative">
  <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-black">My Account</h1>
    </div>
    <div className="lg:w-10/12 md:w-2/3 mx-auto">

      {/* Account Details */}
      <h1 className='pb-5 text-xl font-sans font-semibold text-[#44B0B7]'>1. Account Details</h1>
        ...
        <div className="flex flex-wrap -m-2">
          <div className='w-full sm:flex'>
            <div className="p-2 w-full sm:w-1/2">
              <div className="relative">
                ...
                <input onChange={handleChange} value={firstname} type="text" id="firstname" name="firstname" className="w-full bg-[#f7f7f7] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
            </div>
            <div className="p-2 w-full sm:w-1/2">
              <div className="relative">
                  <label htmlFor="lastname" className="leading-7 text-sm text-gray-600">Last Name</label>
                  <input onChange={handleChange} value={lastname} type="text" id="lastname" name="lastname" className="w-full bg-[#f7f7f7] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
            </div>
          </div>
          <div className="p-2 w-full">
            <div className="relative">
              ...
              {user && user.token ? <input value={user.email} type="text" className="w-full bg-[#f7f7f7] cursor-not-allowed bg-opacity-50 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" readOnly/>: 
              <input onChange={handleChange} value={email} type="text" id="email" name="email" className="w-full bg-[#f7f7f7] rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="your.email@gmail.com" required  />}
            </div>
          </div>
          <div className="p-2 w-full">
            <div className="relative">
          ...
          <div className="px-2 mt-3 md:mt-5 w-full bg-[#f7f7f7] rounded-md">
            <button type='submit' className="flex ml-auto items-center bg-[#29D0d1] hover:bg-[#44B0B7] text-white rounded-xl font-semibold border-0 py-2 px-10 focus:outline-nonetext-lg mt-4 md:mt-0">Save</button>
          </div>
        </div>
      </form>
      ...
      {/* Password Setting */}
      <div className='mt-10'>
        <h1 className='pb-5 text-xl font-sans font-semibold text-[#44B0B7]'>2. Change Password</h1>
        ...
        <div className="flex flex-wrap -m-2">
          ...
          <div className='w-full sm:flex'>
            ...
            <div className="p-2 w-full sm:w-1/2">
              <div className="relative">
                ...
                <input onChange={handleChange} value={npassword} type="password" id="npassword" name="npassword" className="w-full bg-[#f7f7f7] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
            </div>
            <div className="p-2 w-full sm:w-1/2">
              <div className="relative">
                <label htmlFor="cnpassword" className="leading-7 text-sm text-gray-600">Confirm New Password</label>
                <input onChange={handleChange} value={cnpassword} type="password" id="cnpassword" name="cnpassword" className="w-full bg-[#f7f7f7] bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
              </div>
            </div>
          </div>
          ...
          <div className="px-2 mt-3 md:mt-5 w-full bg-[#f7f7f7] rounded-md">
            <button type='submit' className="flex ml-auto items-center bg-[#29D0d1] hover:bg-[#44B0B7] text-white rounded-xl font-semibold border-0 py-2 px-10 focus:outline-none text-lg mt-4 md:mt-0">Save</button>
          </div>
        </div>
        </form>
      </div>
