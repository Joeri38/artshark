...
export default function App({ Component, pageProps: { session, ...pageProps } }) {
  ...
  // Add item to cart 
  const addToCart = (id, size, color, sex, name, series, price, stripePriceId, img, qty) =>{
    let newCart = cart;
    ...
    if (itemIdx != -1) {
      ...
      newCart.push({ id, size, color, sex, name, series, stripePriceId, img, price: price, qty: 1});
