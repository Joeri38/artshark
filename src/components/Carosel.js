...
function Carosel() {
  return (
    <section className="text-gray-600 bg-[#f7f7f7] body-font">
        <div className="max-w-6xl container mx-auto flex py-6 px-12 sm:py-6 sm:px-6 md:py-24 md:flex-row flex-col items-center">
          <div className="md:w-1/2 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="text-xl sm:text-2xl pb-10 md:pb-8 tracking-wider md:text-4xl font-bold text-gray-900">AS infused Art for the Future</h1>
